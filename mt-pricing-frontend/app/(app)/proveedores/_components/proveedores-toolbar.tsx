...
export function ProveedoresToolbar() {
  ...
  const tFilters = useTranslations("proveedores.filters");
  const { filters, setFilter, clear, hasFilters } = useProveedoresListFilters();
    ...
    >
      <label className="relative w-full sm:max-w-sm">
        ...
        <Input
          ...
          className="pl-8"
          data-testid="proveedores-search"
        />
      </label>
      ...
      >
        <SelectTrigger
          ...
          data-testid="proveedores-currency-filter"
        >
      ...
      >
        <SelectTrigger
          ...
          data-testid="proveedores-active-filter"
        >
      ...
      {hasFilters ? (
        <Button
          ...
          size="sm"
          onClick={clear}
          data-testid="proveedores-clear-filters"
        >
