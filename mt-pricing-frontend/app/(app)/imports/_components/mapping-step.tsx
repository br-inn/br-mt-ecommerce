...
const TARGET_FIELDS = [
  ...
  { value: "dn", label: "dn (diámetro nominal)" },
  { value: "pn", label: "pn (presión nominal)" },
  { value: "material", label: "material" },
  { value: "size", label: "size (medida)" },
  ...
  { value: "specs.name_it", label: "specs.name_it" },
  { value: "specs.name_pt", label: "specs.name_pt" },
