...
_STATIC_GROUPS: list[tuple[str, str, str, list[str]]] = [
    ...
    ("stainless_steel_316l", "Stainless Steel 316L", "metal", [
        "ss316l", "316l", "1.4404", "aisi 316l",
    ]),
    ("cast_iron", "Cast Iron / Fundición Gris", "metal", [
        "cast iron", "grey iron", "gray iron", "gg25", "en-gjl-250",
        "en gjl 250", "gjl-250", "hierro fundido", "fonte grise",
        "cast_iron",
    ]),
    ...
    ("pvc", "PVC", "polymer", [
        "pvc", "upvc", "u-pvc", "rigid pvc", "pvc-u",
        "polyvinyl chloride",
    ]),
    ("cpvc", "CPVC", "polymer", [
