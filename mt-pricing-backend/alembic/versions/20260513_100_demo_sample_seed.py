...
_PRODUCTS = [
    ...
    (
        "4222015", "ball_valve", "VALV_LATON_PN30",
        "HIDROSANITARIO", "VALV.LATÓN CARLAS+EMPOTRAR",
        "Ball Valve Long Neck", "brass", '1/2"', "PN30", "threaded", '1/2"',
        -20, 120, 30.0,
        0.21, "84818081", 'VALVULA ESFERA EMPOTRAR H-H PN30 ROSCAR CARLA 1/2"',
        {"alloy": ["CW617N"], "standards": ["ISO228/1", "UNEEN12165"],
         "end_connection": ["threaded"], "applications": ["drinking_water"],
    ...
    (
        "4092040", "ball_valve", "VALV_LATON_PN25",
        "HIDROSANITARIO", "VALV.LATÓN PN-25",
        "Ball Valve Full Bore", "brass", '1 1/2"', "PN25", "threaded", "DN40",
        -20, 120, 25.0,
        0.715, "84818081", 'VALVULA ESFERA PN25 H-H PALANCA ACERO CARBONO AZUL 1 1/2"',
        {"alloy": ["CW617N", "AISI304"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water", "gas"],
         "handle_color": "blue", "handle_material": "carbon_steel",
         "materials": {"body": "brass", "ball": "brass", "stem": "brass"}},
    ...
    (
        "4295040", "ball_valve", "VALV_LATON_PN30",
        "HIDROSANITARIO", "VALV.LATÓN PN-30",
        "Ball Valve Full Bore", "brass", '1 1/2"', "PN30", "threaded", "DN40",
        -20, 120, 30.0,
        0.886, "84818081", 'VALVULA ESFERA PN30 H-H CON PALANCA INOXIDABLE ROJA 1 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water", "gas"],
         "handle_color": "red", "handle_material": "stainless_steel",
         "materials": {"body": "brass", "ball": "brass", "stem": "brass"}},
    ...
    (
        "4091040", "ball_valve", "VALV_LATON_PN25",
        "HIDROSANITARIO", "VALV.LATÓN PN-25",
        "Ball Valve Full Bore M-F", "brass", '1 1/2"', "PN25", "threaded", "DN40",
        -20, 120, 25.0,
        0.780, "84818081", 'VALVULA ESFERA PN25 M-H PL. ACERO CARBONO AZUL 1 1/2"',
        {"alloy": ["CW617N", "AISI304"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water", "gas"],
         "handle_color": "blue", "handle_material": "carbon_steel",
         "materials": {"body": "brass", "ball": "brass", "stem": "brass"}},
    ...
    (
        "4097015", "ball_valve", "VALV_LATON_PN30",
        "HIDROSANITARIO", "VALV.LATÓN PN-30",
        "Ball Valve M-F PN30", "brass", '1/2"', "PN30", "threaded", '1/2"',
        -20, 120, 30.0,
        0.181, "84818081", 'VALVULA ESFERA PN30 M-H PALANCA ERG. INOXIDABLE ROJA 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water", "gas"],
         "handle_color": "red", "handle_material": "stainless_steel",
         "materials": {"body": "brass", "ball": "brass", "stem": "brass"}},
    ...
    (
        "4102015", "ball_valve", "VALV_LATON_PN30",
        "HIDROSANITARIO", "VALV.LATÓN PN-30",
        "Ball Valve Full Bore Butterfly Handle", "brass", '1/2"', "PN30", "threaded", '1/2"',
        -20, 120, 30.0,
        0.145, "84818081", 'VALVULA ESFERA PN30 H-H, MANDO PALOMILLA ROJA 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water", "gas"],
         "handle_type": "butterfly", "handle_color": "red",
         "materials": {"body": "brass", "ball": "brass", "stem": "brass"}},
    ...
    (
        "4113015", "gate_valve", "VALV_COMPUERTA_LATON",
        "HIDROSANITARIO", "VALV.LATÓN COMPUERTA",
        "Gate Valve PN10", "brass", '1/2"', "PN10", "threaded", '1/2"',
        0, 120, 20.0,
        0.180, "84818020", 'VALVULA COMPUERTA PN10 PASO STANDAR H-H 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "ISO228/1"],
         "end_connection": ["threaded"], "applications": ["water"],
    ...
    (
        "4215040", "check_valve", "VALV_RETENCION_LATON",
        "HIDROSANITARIO", "VALV.LATÓN RETENCIÓN",
        "Check Valve Light Type", "brass", '1 1/2"', "PN25", "threaded", "DN40",
        -20, 100, 25.0,
        0.565, "84818099", 'VALVULA RETENCION LIGERA OBTURADOR METALICO H-H 1 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "EN-12165", "ISO228/1", "UNEEN1717"],
         "end_connection": ["threaded"], "applications": ["water", "heating"],
         "shutter_type": "metal",
    ...
    (
        "440901510", "angle_valve", "VALV_ESCUADRA_DECO",
        "HIDROSANITARIO", 'VALV.LATÓN ESC. "DECO"',
        "Angle Valve Deco", "brass", '1/2"', "PN10", "compression", '1/2"x3/8"',
        None, None, 10.0,
        0.215, "84818099", 'VALVULA ESCUADRA "DECO" MANDO REDONDO 1/2"X3/8"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "ISO228/1", "UNEEN12165"],
    ...
    (
        "5128040", "ball_valve", "VALV_INOX_2PCS",
        "INDUSTRIAL", "VÁLVULAS INOXIDABLES-ESFERA",
        "Ball Valve SS 2-piece Flanged", "stainless_steel", '1 1/2"', "PN40", "flanged", "DN40",
        -30, 180, 40.0,
        5.930, "84818030", 'VALVULA ESFERA INOX. BOLA A-316 2 PIEZAS PN40 1 1/2"',
        {"alloy": ["AISI316", "AISI304", "A351CF8M"],
         "standards": ["ANSI150", "API598", "API607", "ASME16.5", "EN1092", "ISO5211"],
         "end_connection": ["flanged"], "applications": ["industrial", "chemical", "oil_gas"],
         "materials": {"body": "AISI316", "ball": "AISI316", "stem": "AISI316",
                       "seat": "PTFE", "seals": "PTFE"}},
    ...
    (
        "0910040", "ball_valve", "VALV_INOX_2PCS",
        "INDUSTRIAL", "VÁLVULAS INOXIDABLES-2 PIEZAS",
        "Ball Valve SS 2-piece Threaded", "stainless_steel", '1 1/2"', "PN63", "threaded", "DN40",
        -20, 180, 63.0,
        1.200, "84818030", 'VALVULA INOX. DE DOS PIEZAS ROSCAR H-H 11/2" PALANCA AZUL',
        {"alloy": ["AISI316", "AISI304"],
         "standards": ["DIN259", "ISO-7", "ISO228", "ISO5211", "ISO7-1"],
         "end_connection": ["threaded"], "applications": ["industrial", "water", "air"],
         "handle_color": "blue",
         "materials": {"body": "AISI316", "ball": "AISI316", "stem": "AISI304",
                       "seat": "PTFE", "seals": "PTFE"}},
    ...
    (
        "5113050", "gate_valve", "VALV_COMPUERTA_FUND",
        "INDUSTRIAL", "VÁLVULAS FUNDICIÓN-COMPUERTAS",
        "Gate Valve Resilient Wedge", "ductile_iron", "DN50", "PN16", "flanged", "DN50",
        -10, 80, 16.0,
        9.400, "84818020", 'VALVULA COMPUERTA C/BRIDAS, EJE FIJO C. ELASTICO EPDM DN50',
        {"alloy": [], "standards": ["EN1074-2", "ISO7259", "EN1092", "EN558"],
         "end_connection": ["flanged"], "applications": ["water_supply", "fire_protection"],
         "lining": "epoxy", "wedge_coating": "EPDM",
         "materials": {"body": "ductile_iron", "wedge": "ductile_iron+EPDM",
                       "stem": "stainless_steel", "handwheel": "ductile_iron"}},
...
def upgrade() -> None:
    ...
    # 3. PRODUCTS
    # =======================================================================
    for (sku, fam_code, sub_code, fam_text, sub_text,
         type_, material, dn, pn, connection, size,
         temp_min, temp_max, pressure_bar,
         weight, intrastat, erp_name,
         specs_extra, dimensions, packaging,
         coste_aed, pvp_aed, image_url) in _PRODUCTS:
    ...
    for (sku, *_, coste_aed, pvp_aed, __) in _PRODUCTS:
        ...
        breakdown_fba = _j({"fob": fob, "freight": freight,
                             "customs": customs, "fba_fees": fba_fees})
        breakdown_b2c = _j({"fob": fob, "freight": freight,
                             "customs": customs, "payment_fees": round(coste_aed*0.02, 4),
                             "marketing": marketing})
    ...
    for (sku, *_, coste_aed, pvp_aed, __) in _PRODUCTS:
        ...
        breakdown = _j({"cost": coste_aed, "target_pvp": pvp_aed,
                        "margin_pct": margin, "scheme": "FBA"})
    ...
    po1_id = bind.execute(text(
        "SELECT id FROM purchase_orders WHERE po_number = 'MT-PO-2026-001'"
    )).scalar()

    fx_id = bind.execute(text(
    ...
    for sku, qty_ord, qty_rec, unit_price, breakdown in _PO001_LINES:
        ...
        """))
        pol_id = bind.execute(text(
            f"SELECT id FROM purchase_order_lines WHERE po_id='{po1_id}' AND sku='{sku}'"
        )).scalar()
        ...
        """))
        gr_id = bind.execute(text(
            f"SELECT id FROM goods_receipts WHERE po_line_id='{pol_id}' LIMIT 1"
        )).scalar()
    ...
    po2_id = bind.execute(text(
        "SELECT id FROM purchase_orders WHERE po_number = 'MT-PO-2026-002'"
    )).scalar()
    ...
    for sku, qty_ord, qty_rec, unit_price, breakdown in _PO002_LINES:
        ...
        if qty_rec > 0:
            pol_id = bind.execute(text(
                f"SELECT id FROM purchase_order_lines WHERE po_id='{po2_id}' AND sku='{sku}'"
            )).scalar()
    ...
    po3_id = bind.execute(text(
        "SELECT id FROM purchase_orders WHERE po_number = 'MT-PO-2026-003'"
    )).scalar()
