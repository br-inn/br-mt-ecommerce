...
def upgrade() -> None:
    ...
    op.add_column(
        "products", sa.Column("units_per_box", sa.Integer(), nullable=False, server_default="1")
    )
    op.add_column(
        "products",
        sa.Column("b2c_labeling_aed", sa.Numeric(10, 4), nullable=False, server_default="0"),
    )
    op.add_column(
        "products",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_channel_fee_params_channel"
        ),
        sa.ForeignKeyConstraint(
            ["route_id"], ["trade_route_params.id"], name="fk_channel_fee_params_route"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_channel_scheme_params_channel"
        ),
        sa.UniqueConstraint("channel_id", "fulfillment_scheme", name="uq_channel_scheme_params"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_channel_product_logistics_channel"
        ),
        sa.UniqueConstraint("product_sku", "channel_id", name="uq_channel_product_logistics"),
    )
    ...
    op.create_table(
        ...
        sa.Column("updated_by", sa.Text()),
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_channel_margin_targets_channel"
        ),
        sa.ForeignKeyConstraint(
            ["family_id"], ["families.id"], name="fk_channel_margin_targets_family"
        ),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_channel_margin_overrides_channel"
        ),
        sa.UniqueConstraint(
            "product_sku", "channel_id", "selling_model", name="uq_channel_margin_overrides"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.Text()),
        sa.ForeignKeyConstraint(
            ["channel_id"], ["channels.id"], name="fk_pricing_scenarios_channel"
        ),
    ...
    # ── 10. Lookup indexes ────────────────────────────────────────────────
    op.create_index("idx_channel_fee_params_channel", "channel_fee_params", ["channel_id"])
    op.create_index(
        "idx_channel_scheme_params_lookup",
        "channel_scheme_params",
        ["channel_id", "fulfillment_scheme"],
    )
    op.create_index(
        "idx_channel_product_logistics_sku_ch",
        "channel_product_logistics",
        ["product_sku", "channel_id"],
    )
    op.create_index(
        "idx_channel_product_logistics_channel", "channel_product_logistics", ["channel_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "idx_pricing_scenarios_lookup", "pricing_scenarios", ["channel_id", "selling_model"]
    )
...
def downgrade() -> None:
    ...
    for tbl in [
        ...
        op.drop_table(tbl)
    for col in ["ceiling_basis", "b2c_labeling_aed", "units_per_box", "catalog_pvp_eur", "pe_eur"]:
