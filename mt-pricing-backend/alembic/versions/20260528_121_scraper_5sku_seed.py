...
_PRODUCTS = [
    ...
    (
        ...
        -20, 100, 25.0, 0.565, "84818099",
        'VALVULA RETENCION LIGERA OBTURADOR METALICO H-H 1 1/2"',
        {"alloy": ["CW617N"], "standards": ["DIN259", "EN-12165", "ISO228/1"],
    ...
    (
        ...
        -20, 180, 63.0, 1.200, "84818030",
        'VALVULA INOX. DE DOS PIEZAS ROSCAR H-H 11/2" PALANCA AZUL',
        {"alloy": ["AISI316", "AISI304"], "standards": ["DIN259", "ISO228", "ISO5211"],
...
_TRANSLATIONS = {
    "4222015": {
        ...
        "en": ('F-F PN30 LONG NECK THREADED BALL VALVE 1/2"',
               "Long neck ball valve PN30 threaded ends. Brass CW617N. Drinking water."),
    },
    "4097015": {
        "es": ('VALVULA ESFERA PN30 M-H PALANCA INOXIDABLE ROJA 1/2"',
               "Válvula esfera PN30 macho-hembra con palanca roja inoxidable. Latón CW617N."),
        "en": ('M-F PN30 BRASS BALL VALVE RED SS HANDLE 1/2"',
    ...
    "4113015": {
        ...
        "en": ('F-F BRASS GATE VALVE PN10 STANDARD BORE 1/2"',
    ...
    "4215040": {
        ...
        "en": ('F-F BRASS CHECK VALVE LIGHT TYPE METAL SHUTTER 1 1/2"',
               "Light type brass check valve with metal shutter. PN25 threaded ends."),
    },
    "0910040": {
        "es": ('VALVULA INOX. 2 PIEZAS ROSCAR H-H 1 1/2" PALANCA AZUL',
               "Válvula esfera inoxidable 2 piezas PN63 con palanca azul. AISI316."),
        "en": ('SS316 2-PIECE BALL VALVE F-F THREADED PN63 1 1/2" BLUE HANDLE',
...
def upgrade() -> None:
    ...
    for (sku, *_, coste_aed, pvp_aed, __) in _PRODUCTS:
        ...
        bd_b2c = _j({"fob": fob, "freight": freight, "customs": customs,
                     "payment_fees": round(coste_aed * 0.02, 4), "marketing": mkt})
    ...
    for (sku, *_, coste_aed, pvp_aed, __) in _PRODUCTS:
        ...
        bd = _j({"cost": coste_aed, "target_pvp": pvp_aed,
