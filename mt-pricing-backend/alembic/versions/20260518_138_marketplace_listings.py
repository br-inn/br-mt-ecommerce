...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("bullet_points", ARRAY(sa.Text()), nullable=False, server_default=sa.text("'{}'::text[]")),
        ...
        sa.UniqueConstraint("product_sku", "marketplace", name="uq_marketplace_listings_sku_marketplace"),
    )
