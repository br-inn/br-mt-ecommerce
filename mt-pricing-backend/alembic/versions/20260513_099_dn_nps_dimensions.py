...
def upgrade() -> None:
    ...
    op.create_table(
        "dn_nps_reference",
        sa.Column("dn_nominal", sa.Text, primary_key=True,
                  comment="Tamaño nominal métrico: '80', '100', '150' (sin prefijo DN)"),
        sa.Column("nps_nominal", sa.Text, nullable=False,
                  comment="Tamaño nominal americano: '3', '4', '6' (sin comillas)"),
        sa.Column("nps_label", sa.Text, nullable=False,
                  comment="Etiqueta legible NPS: '3\"', '4\"', '6\"'"),
        sa.Column("od_pipe_mm", sa.Numeric(8, 2), nullable=True,
    ...
    op.bulk_insert(
        ...
        [
            {"dn_nominal": r[0], "nps_nominal": r[1],
             "nps_label": r[2], "od_pipe_mm": r[3]}
    ...
    op.create_table(
        ...
        sa.Column("standard_system", sa.String(16), nullable=False,
        ...
        sa.Column("pressure_class", sa.String(20), nullable=True,
        ...
        sa.Column("bore_mm", sa.Numeric(8, 2), nullable=True,
                  comment="Diámetro de paso (waterway bore) en mm — la dimensión que el spec llama dn_real"),
        sa.Column("face_to_face_mm", sa.Numeric(8, 2), nullable=True,
                  comment="Distancia cara a cara (construcción) en mm"),
        sa.Column("end_to_end_mm", sa.Numeric(8, 2), nullable=True,
                  comment="Distancia extremo a extremo (con bridas) en mm"),
        sa.Column("flange_od_mm", sa.Numeric(8, 2), nullable=True,
                  comment="Diámetro exterior de brida en mm"),
        sa.Column("bolt_circle_mm", sa.Numeric(8, 2), nullable=True,
        ...
        sa.Column("bolt_size", sa.String(16), nullable=True,
